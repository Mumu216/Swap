                        ...
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <figure class="product-main-image">
                                            ...
                                            @foreach($productDetails->images as $image)
                                                @if($p > 0 )
                                                <img src="{{ asset('backend/img/products/'   .  $image->image) }}" class="product-image" alt="{{ $productDetails->title  }}">
                                                @endif
                                                @php $p--; @endphp
                                            @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title">{{ $productDetails->title }}</h1><!-- End .product-title -->
                                    ...
                                    <div class="product-price">
                                        ...
                                        <span class="amount">৳ {{ $productDetails->offer_price }}</span>
                                        @endif
                                    ...
                                    <div class="details-filter-row details-row-size">
                                        @if( $productDetails->quantity > 0 )
                                          Quantity:  {{ $productDetails->quantity }} Pcs
