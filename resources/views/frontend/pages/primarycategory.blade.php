            ...
            <div class="page-content">
                <div class="container">
                	<div class="row">
                       ...
                       @foreach(App\Models\Category::where('is_parent' , $pcategory->id)->get() as $cCat)

                        @foreach(App\Models\Product::orderBy('id' , 'asc')->where('category_id' , $cCat->id)->get() as $product)
